...
export const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    "about.story": "dot.page נוסדה מתוך חזון לגשר בין עיצוב מרהיב לטכנולוגיה חזקה, והפכה לסוכנות דיגיטלית מלאה שמביאה תוצאות. אנחנו משלבים יצירתיות עם אסטרטגיות מבוססות נתונים כדי לבנות אתרים שלא רק נראים מדהים אלא גם ממירים מבקרים ללקוחות נאמנים.",
